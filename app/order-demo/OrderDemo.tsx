...
import { getOrderDemoContent, IOrderDemoContent } from "../lib/contentful/contentful-api";
import { replaceOWithPaintedO } from "../lib/utils/utils";
import FormOrderDemo from "../components/ui/forms/FormOrderDemo";
import Loader from "../components/ui/Loader";

export default function OrderDemo() {
    const [componentContent, setComponentContent] = useState<IOrderDemoContent | null>(null);

    useEffect(() => {
        async function getContent() {
            const content = await getOrderDemoContent();
